...
options = {
  ...
  tracking_frame = "base_link",              -- Spot IMU/body in TF
  ...
  use_odometry = true,                 -- keep false unless you wire Spot odom into Cartographer
  use_nav_sat = false,
  use_landmarks = false,
...
TRAJECTORY_BUILDER_2D.min_range = 1.0    -- matches VelodynePuck.minRange
TRAJECTORY_BUILDER_2D.max_range = 100.0  -- matches VelodynePuck.maxRange
